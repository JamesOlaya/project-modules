...
<div v-if="product.productOptions.length>0 && product.optionValues.length>0" class="options mb-4 d-flex" v-for="(option,index) in product.productOptions">
        <h3 class="options mr-2">@{{option.description}}:</h3>
         <!-- If option type-->
