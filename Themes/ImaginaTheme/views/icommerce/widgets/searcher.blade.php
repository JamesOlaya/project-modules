            ...
            <div id="dropdownSearch"
                ...
                <div class="input-group my-3">
                    ...
                    <div class="input-group-append" v-on:click="view_result()">
                        <button class="btn btn-warning text-white" type="submit" id="button-addon2"><i
                        ...
                        <div class="cart-items-item row">
                            ...
                            <a v-bind:href="item.url"
                               class="cart-img pr-0  float-left col-3 text-center">
                                <img class="img-fluid"
                                     v-bind:src="item.mediaFiles.mainimage.smallThumb"
    ...
    <script>
        const vue_searcher = new Vue({
            ...
            data: {
                ...
                criterion: '',
                path: '',
                route_view: "{{ url(trans('icommerce::routes.store.index.index')) }}",
            },
            methods: {
                search: function(){
